 ...
 * @author stavness
 */
public class ElasticFoundationForceBehavior
   extends ContactForceBehavior {
    ...
    */
   public ElasticFoundationForceBehavior () {
   }

   public ElasticFoundationForceBehavior (double youngsModulus, 
...
//      handler = h;
   ...
   public void computeResponse (
      ...
      Vector3d normal, double area, int flags) {
