...
public class JawModelFEMInverse extends JawModel{
  
   
   double PCAscaling = 1;
   
   double scar_stiffness = 0;
  ...
  public ArrayList<Muscle> myAttachedMuscles = new ArrayList<Muscle>();
   ...
   new PropertyList (JawModelFEMInverse.class, JawModel.class);
   ...
   */
   ...
   public PolygonalMesh loadFemMesh(String meshName, double scale){
      String meshFilename = ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,
         "geometry/" + meshName);
  ...
  protected void createBiteConstraintsPPF () {

     
     double PPFStiffness = 100000;
     double PPFDamping = 50;
  
     PointPlaneForce  CL = new PointPlaneForce();
    
     CL.setPoint (frameMarkers ().get ("lbite"));
     CL.setNormal (new Vector3d (0,0,-1));;
     CL.setUnilateral(true);     
     CL.setPlaneSize(25);
     CL.setName("LBITE");
     CL.setForceType(ForceType.LINEAR);
     CL.setStiffness (PPFStiffness);
     CL.setDamping (PPFDamping);
     //CL.setCenter (new Point3d(28.951207, -67.02249, -43.405483));
     
     CL.setCenter (frameMarkers ().get ("lbite").getPosition ());
     ...
     props.setFaceStyle(Renderer.FaceStyle.FRONT_AND_BACK);
     props.setAlpha(0.8);
     CL.setRenderProps(props);
     
     
     
     PointPlaneForce  CR = new PointPlaneForce();
     
     CR.setPoint (frameMarkers ().get ("rbite"));
     CR.setNormal (new Vector3d (0,0,-1));;
     CR.setUnilateral(true);     
     CR.setPlaneSize(25);
     CR.setName("RBITE");
     CR.setForceType(ForceType.LINEAR);
     CR.setStiffness (PPFStiffness);
     CR.setDamping (PPFDamping);
     CR.setCenter (new Point3d(-20.85772, -67.02249, -43.405483));
     addForceEffector (CR);
  
     RenderProps props2 = new RenderProps(myRenderProps);
     props2.setFaceStyle(Renderer.FaceStyle.FRONT_AND_BACK);
     props2.setAlpha(0.8);
     CR.setRenderProps(props);
   ...
   protected void createBiteConstraints (){
      ...
      Vector3d trans = new Vector3d(-20.85772, -67.02249, -43.405483);
      ...
      Vector3d trans2 = new Vector3d(28.951207, -67.02249, -43.405483);      
...
// Creates and returns a ColorBar renderable object
   ...
   public void addCapsule() throws IOException {      
      ...
      FemModel3d caps_right = new FemModel3d ("capsule_r");
       ...
       ArrayList<Integer> attached_points_l_man = readIntList(ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,"geometry"+"/capsule_l_fixedNodes_man_wedge_fine_5.txt"));
       ...
       ArrayList<Integer> attached_points_l_skull = readIntList(ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,"geometry"+"/capsule_l_fixedNodes_skull_wedge_fine_5.txt"));
       ...
       ArrayList<Integer> attached_points_r_man = readIntList(ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,"geometry"+"/capsule_r_fixedNodes_man_wedge_fine_19.txt"));   
       ...
       ArrayList<Integer> attached_points_r_skull = readIntList(ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,"geometry"+"/capsule_r_fixedNodes_skull_wedge_fine_19.txt"));
   ...
   public JawModelFEMInverse () throws IOException {
      super();
   }

   
   public JawModelFEMInverse (String name) throws IOException {
      super();
      this.setName (name);
      ...
      JawModel.muscleList = readStringList(ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,"geometry/"+muscleListFilename));
      JawModel.bodyInfoList = readBodyInfoList(ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,"geometry/"+bodyListFilename));
      femInfoList = readFemInfoList(ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,"geometry/"+femListFilename));
      
      JawModel.muscleInfo = readMuscleInfo(ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,"geometry/"+muscleInfoFilename));
      JawModel.muscleGroupInfo = readMuscleGroupsInfo(ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,"geometry/"+muscleGroupInfoFilename));
      ArrayList<RigidBody> bodies = JawModel.assembleRigidBodies(bodyInfoList, amiraTranformation,ArtisynthPath.getSrcRelativePath (JawModelFEMInverse.class, ""));
      ...
      String meshFilename = (ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,"geometry"+"/mandible_with_cartilage2.obj"));
      PolygonalMesh mesh = new PolygonalMesh();
      try {
         mesh.read(new BufferedReader(new FileReader(meshFilename)));
      } catch (IOException e) {
      ...
      ArrayList<FrameMarker>markers = JawModel.assembleMarkers(muscleList, muscleInfo, myRigidBodies, amiraTranformation, ArtisynthPath.getSrcRelativePath (JawModelFEMInverse.class, ""));
      ...
      wrappedMuscleList = readStringList(ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,"geometry/"+wrappedMuscleListFilename));
      ...
      */
      ...
      closerMuscleList = JawModel.createMuscleList(readStringList(ArtisynthPath.getSrcRelativePath(JawModelFEMInverse.class,"geometry/"+"closerMuscleList.txt")), muscleInfo, myAttachedMuscles);
   ...
   public void addMidScarSpring(String name, Point3d loc)
   {
      ...
      scar.setMaterial (new RotAxisFrameMaterial (scar_stiffness/3, 0, 10, 0));
   ...
   void editMuscleOptLen() {
      
      AxialSpring rip =  axialSprings ().get ("rip");
      AxialMuscleMaterial rip_material = (AxialMuscleMaterial) rip.getMaterial ();
      rip_material.setOptLength (30.9);
      
      
      AxialSpring lpm =  axialSprings ().get ("lpm");
      AxialMuscleMaterial lpm_material = (AxialMuscleMaterial) lpm.getMaterial ();
      lpm_material.setOptLength (33.7);
      
      
      AxialSpring rpm =  axialSprings ().get ("rpm");
      AxialMuscleMaterial rpm_material = (AxialMuscleMaterial) rpm.getMaterial ();
      rpm_material.setOptLength (33.7);
