...
public class JawFemDemoOptimizeTwoWithSafety extends RootModel implements ActionListener {
   ...
   String myGeoDir = PathFinder.getSourceRelativePath (
      JawFemDemoOptimizeTwoWithSafety.class, "geometry/");
   ...
   protected static PropertyList myProps = new PropertyList (JawFemDemoOptimizeTwoWithSafety.class, RootModel.class);
 ...
 public double getPercMechanicalStimRightBuiltin() {
  ...
  public double getSafetyRight() {
   ...
   public JawFemDemoOptimizeTwoWithSafety () {
      
   }

   
   public JawFemDemoOptimizeTwoWithSafety (String name){
      super(null);
   }
...
public FemModel3d createFemModel (
   ...
   public void setWorkingDir() {
      ...
      ArtisynthPath.getSrcRelativePath(JawFemDemoOptimizeTwoWithSafety.class, workingDirname));
