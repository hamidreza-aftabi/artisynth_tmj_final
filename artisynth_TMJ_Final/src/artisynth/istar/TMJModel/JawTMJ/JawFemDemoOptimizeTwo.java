...
public class JawFemDemoOptimizeTwo extends RootModel implements ActionListener {
   ...
   String myGeoDir = PathFinder.getSourceRelativePath (
      JawFemDemoOptimizeTwo.class, "geometry/");
   ...
   protected static PropertyList myProps = new PropertyList (JawFemDemoOptimizeTwo.class, RootModel.class);
 ...
 public double getMaxNodalStress() {
  ...
  public double getMaxMechanicalStimRightBuiltin() {
      ...
      return computeStressStrainDonor1RightBuiltin();
...
/*
   ...
   */
   ...
   public JawFemDemoOptimizeTwo () {
      
   }

   
   public JawFemDemoOptimizeTwo (String name){
      super(null);
   }
   ...
   public double computePercStressStrainDonor0LeftBuiltin() {
      ...
      for (FemElement3d element : elemsNearSurfaceLeft) {
         ...
         if (elementStrainEnergyDensity/(1000 * 0.0001) > 0.0396) {
...
public double computeStressStrainDonor0LeftBuiltin(){
   ...
   HashSet<FemElement3d> elemsNearSurfaceLeft =  new HashSet<FemElement3d>();
      ...
      return  MaxStrainEnergyDensity/(1000 * 0.0001); //Mechanical Stimulus (mj/g): divided by unit Conversion Times the Density for 
...
public double computeStressStrainDonor1RightBuiltin(){
   ...
   public void setWorkingDir() {
      ...
      ArtisynthPath.getSrcRelativePath(JawFemDemoOptimizeTwo.class, workingDirname));
