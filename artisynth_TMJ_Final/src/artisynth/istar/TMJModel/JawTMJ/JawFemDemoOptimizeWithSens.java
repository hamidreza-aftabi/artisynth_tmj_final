...
public class JawFemDemoOptimizeWithSens extends RootModel implements ActionListener {
   ...
   String myGeoDir = PathFinder.getSourceRelativePath (
      JawFemDemoOptimizeWithSens.class, "geometry/");
   ...
   public static PropertyList myProps = new PropertyList (JawFemDemoOptimizeWithSens.class, RootModel.class);
...
/*
   ...
   */
   ...
   public JawFemDemoOptimizeWithSens () {
      
   }

   
   public JawFemDemoOptimizeWithSens (String name){
      super(null);
   }
  ...
  elementsCloseToSurface = new HashSet<>();
   ...
   public void setWorkingDir() {
      ...
      ArtisynthPath.getSrcRelativePath(JawFemDemoOptimizeWithSens.class, workingDirname));
