...
public class JawFemDemoWithBolusInverseTMJStress extends RootModel implements ActionListener {
   ...
   public JawFemDemoWithBolusInverseTMJStress () {
   }

   public JawFemDemoWithBolusInverseTMJStress (String name){
      super(null);
   }
   ...
   public void setWorkingDir() {
      ...
      ArtisynthPath.getSrcRelativePath(JawFemDemoWithBolusInverseTMJStress.class, workingDirname));
  ...
  public void attach(DriverInterface driver) {
     ...
     loadProbes("inverse_probe_tmj_stress.art");
